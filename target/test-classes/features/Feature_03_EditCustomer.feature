...
Feature: Edit customer
  ...
  Scenario: Edit customer with empty customer id
    ...
    Then Verify successfully with the message "Customer ID is required"
  ...
  Scenario Outline: Edit customer with input numeric value name field
    ...
    Then Verify successfully with the message "<Message>"
  ...
  Scenario: Edit customer with input special value customer ID field
    ...
    Then Verify successfully with the message "Address Field must not be blank"
  ...
  Scenario: Edit customer with input special value customer ID field
    ...
    Then Verify successfully with the message "City Field must not be blank"
  ...
  Scenario: Edit customer with input special value customer ID field
    ...
    Then Verify successfully with the message "State must not be blank"
  ...
  Scenario: Edit customer with input special value customer ID field
    ...
    Then Verify successfully with the message "PIN Code must not be blank"
  ...
  Scenario: Edit customer with input special value customer ID field
    ...
    Then Verify successfully with the message "Mobile no must not be blank"
  ...
  Scenario: Edit customer with input special value customer ID field
    ...
    Then Verify successfully with the message "Email-ID must not be blank"
  ...
  Scenario: Edit customer with input special value customer ID field
    ...
    Then Verify successfully with the message "First character can not have space"
    Then Close browser
